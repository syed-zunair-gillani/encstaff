...
AppNewInvoice.propTypes = {
  ...
  tableData: PropTypes.checkPropTypes([], [], 'prop', 'AppNewInvoice'),
  tableLabels: PropTypes.checkPropTypes([], [], 'prop', 'AppNewInvoice'),
...
AppNewInvoiceRow.propTypes = {
  row: PropTypes.checkPropTypes({}, {}, 'prop', 'AppNewInvoiceRow'),
};
